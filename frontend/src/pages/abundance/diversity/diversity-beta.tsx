...
const AbundanceOpterature: FC<any> = () => {
    ...
    const getCompareAbundance = async () => {
        ...
        const resp: any = await axios.post(`/jupyter/abundance-diversity-beta`, {
            ...values,
            project: project,
            // rnak:"SPECIES",
    ...
    return <>
        <Row>
            <Col lg={12} sm={24} xs={24}>
                ...
                <ResultList analysisMethod={"diversity-beta"} shouldTrigger={shouldTrigger} form={form} setTableLoading={setLoading} setTabletData={(data: any) => {
                    // console.log(data)
                    setData(data)
                }}  ></ResultList>
